...
export const INDEXABLE_ROUTES = [
  ...
  '/about',
  '/journal',
  '/journal/45-day-handover-factory-prefabrication',
  '/journal/bwp-plywood-vs-commercial-ply',
  '/journal/chennai-interior-cost-breakdown',
  '/journal/coastal-humidity-interior-finishes',
  '/journal/nri-remote-home-supervision',
  '/journal/vastu-tech-spatial-guide',
  '/portfolio',
  '/portfolio/adyar-3bhk-residence',
  '/portfolio/apartments',
  '/portfolio/ecr-coastal-sanctuary',
  '/portfolio/omr-duplex-penthouse',
  '/portfolio/penthouses',
  '/portfolio/poes-garden-residence',
  '/portfolio/t-nagar-heritage-apartment',
  '/portfolio/the-emerald-villa-adyar',
  '/portfolio/villas',
  '/contact',
  '/careers',
  '/privacy',
