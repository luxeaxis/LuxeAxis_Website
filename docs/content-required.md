...
| ~~The Tamil version~~ | — | **Resolved.** Both documents carried a Language clause stating they were "published in English and Tamil" and giving English precedence in a conflict. No Tamil version exists, so the clause asserted a document that does not. Struck from both at the studio’s direction; the site is English-only throughout. |
