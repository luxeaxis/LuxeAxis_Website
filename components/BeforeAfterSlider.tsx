...
import { useState, useRef, type KeyboardEvent, type TouchEvent, type MouseEvent } from 'react';
  ...
  if (reducedMotion) {
    return (
      <div className={`grid grid-cols-1 gap-4 md:grid-cols-2 ${className}`}>
        <div className="relative overflow-hidden rounded-lg border border-border-subtle" style={{ aspectRatio: aspect }}>
          <Image src={beforeImage.src} alt={beforeImage.alt} fill className="object-cover" />
        ...
        <div className="relative overflow-hidden rounded-lg border border-border-subtle" style={{ aspectRatio: aspect }}>
          <Image src={afterImage.src} alt={afterImage.alt} fill className="object-cover" />
