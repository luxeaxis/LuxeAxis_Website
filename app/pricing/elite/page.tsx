        ...
        <Container>
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-small text-on-surface-3">
              ...
              <span>/</span>
              <li aria-current="page" className="text-accent font-semibold">Elite Tier</li>
            </ol>
          </nav>
          ...
          <Stack gap={6} className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-border-subtle/50">
              ...
              <div>
                ...
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Phased Guarantee</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Concierge Service</span>
              </div>
            </div>
          </Stack>
        </Container>
