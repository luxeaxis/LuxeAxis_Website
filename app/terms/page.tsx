        ...
        <Container>
          ...
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-small text-on-surface-3">
              ...
              <span>/</span>
              <li aria-current="page" className="text-accent font-semibold">Terms of Service</li>
            </ol>
          </nav>
          ...
          <Stack gap={6} className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 pt-8 border-t border-border-subtle/50">
              ...
              <div>
                ...
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Price Escalation</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">45 Days</strong>
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Handover SLA</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">Space OS</strong>
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Governance</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">100%</strong>
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Contractual</span>
              </div>
            </div>
          </Stack>
        </Container>
