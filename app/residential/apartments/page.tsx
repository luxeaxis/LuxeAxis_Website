      ...
      <section className="relative overflow-hidden pt-12 pb-16 min-h-[80vh] flex flex-col justify-center bg-surface-deep border-b border-border-subtle/40 isolate">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <Image
            ...
            alt="Luxe Axis Interior Design for Apartments in Chennai"
            fill
            priority
        ...
        <div className="max-w-4xl mx-auto">
          <BeforeAfterSlider
            beforeImage={{
              ...
              alt: 'Bare Chennai apartment before interior design execution shot on Sony alpha camera',
            }}
            afterImage={{
              src: '/posters/dslr-apt-after.png',
              alt: 'Complete luxury apartment interior design by Luxe Axis shot on Sony alpha camera',
            }}
          />
