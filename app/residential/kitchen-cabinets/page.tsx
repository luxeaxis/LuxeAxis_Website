        ...
        <Container>
          ...
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-small text-on-surface-3">
              ...
              <span>/</span>
              <li aria-current="page" className="text-accent font-semibold">Kitchen Cabinets</li>
            </ol>
          </nav>
          ...
          <Stack gap={6} className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 pt-8 border-t border-border-subtle/50">
              <div>
                ...
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Kitchens Built</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">0.1mm</strong>
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">CNC Tolerance</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">40+</strong>
                <span className="text-overline text-on-surface-3 uppercase tracking-wider">Finish Options</span>
              </div>
              <div>
