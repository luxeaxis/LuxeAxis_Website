...
export default function WardrobePage() {
  const highlights = [
    { title: '1,000+ Wardrobes', desc: 'Custom Built Across Sliding, Walk-In & Hinged Designs' },
    { title: 'BWR Marine Ply', desc: '100% Moisture & Humidity Resistant Carcass' },
    { title: '40+ Shutter Finishes', desc: 'High-Gloss Acrylic, PET Laminate, Tinted Glass & Veneer' },
    { title: 'Flat 10-Year Warranty', desc: 'Covers Shutters, Hinges, Tracks & Internal Fittings' },
  ...
  const testimonials = [
    {
      ...
      location: 'T. Nagar, Chennai',
      quote:
        'Good customization options and excellent quality. The Luxe Axis architects gave detailed explanations on every wardrobe product. Delivered before the expected date!',
      stars: 5,
    },
    {
      name: 'Manoj Kumar',
      location: 'T. Nagar, Chennai',
      quote:
        'Great experience and prompt delivery. Salim helped with every wardrobe customization with utmost patience. The sliding glass shutters look super sleek.',
      stars: 5,
    },
    {
      ...
      location: 'Adyar, Chennai',
      quote:
        'My 3BHK bedroom wardrobes were completed even before the promised handover date. Managed every detail professionally. Excellent execution!',
      stars: 5,
    },
  ];
  ...
  return (
    <main id="main" tabIndex={-1}>
      ...
      <section className="relative overflow-hidden pt-12 pb-16 bg-surface-deep border-b border-border-subtle/40">
        ...
        <Container>
          <Breadcrumbs path="/residential/wardrobe" labels={{ 'wardrobe': "Wardrobe Design" }} />
          ...
          <Stack gap={6} className="max-w-4xl">
            ...
            <p className="text-[length:var(--typography-body-lg-font-size)] text-on-surface-2 font-medium leading-relaxed max-w-3xl">
              Luxe Axis builds wardrobes from factory-cut panels, humidity-resistant marine ply, and soft-close hardware. Every wardrobe installed in 45 days with a flat 10-year warranty on every component.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 pt-8 border-t border-border-subtle/50">
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">1,000+</strong>
                <span className="text-overline text-on-surface-muted uppercase tracking-wider">Wardrobes Built</span>
              </div>
              <div>
                <strong className="block font-display text-h3 text-accent font-bold">45 Days</strong>
                <span className="text-overline text-on-surface-muted uppercase tracking-wider">Installation Guarantee</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="text-overline text-on-surface-muted uppercase tracking-wider">Shutter Finishes</span>
              </div>
              <div>
          ...
          {wardrobeTypes.map((type) => (
            <div key={type.tag} className="lx-liquid-glass rounded-2xl p-6 border border-accent/30 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-display text-h3 font-bold text-on-surface mb-2">{type.title}</h3>
      ...
      >
        <Grid cols={3} gap={6}>
          {internalFittings.map((fit) => (
            <div key={fit.title} className="lx-liquid-glass rounded-xl p-5 border border-accent/30 flex flex-col justify-between">
              <div>
                <h3 className="font-display text-h4 font-bold text-on-surface mb-2">{fit.title}</h3>
                <p className="text-small text-on-surface-2 leading-relaxed mb-3">{fit.desc}</p>
              </div>
              <div className="pt-3 border-t border-border-subtle/40">
                <span className="text-[12px] font-bold text-accent">Config: {fit.spec}</span>
              </div>
            </div>
          ))}
        </Grid>
      ...
      <Section
        ...
        title="What Wardrobe Clients Say About Luxe Axis"
        lede="Verified client reviews from wardrobe projects across Chennai."
      >
        <Grid cols={3} gap={6}>
          {testimonials.map((t) => (
