...
export default async function BedroomPage() {
  const highlights = [
    {
      title: '500+ Bedrooms',
      desc: 'Master Suites, Kids Rooms & Guest Sanctuaries Delivered',
    },
    {
      title: 'Modular Wardrobes',
      desc: 'Factory-Cut BWR Marine Ply Carcass, Humidity & Termite Resistant',
    },
    {
      title: 'Circadian Layered Lighting',
      desc: 'Ambient Coves, Bedside Task Pendants & Internal Profile Lights',
    },
    {
      title: 'Flat 10-Year Warranty',
      desc: 'Comprehensive Coverage Across Every Material, Hinge & Finish',
    },
    {
